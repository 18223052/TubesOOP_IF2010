...
public class ShippingBinMenu extends BaseUIPanel {
    ...
    public void draw(Graphics2D g2) {
        ...
        drawCenteredString(g2, "Shipping Bin", FRAME_X, FRAME_Y - 17, FRAME_WIDTH);

        drawSubWindow(g2, FRAME_X, FRAME_Y, FRAME_WIDTH, FRAME_HEIGHT);
        g2.setFont(new Font("Arial", Font.BOLD, 12));
        g2.setColor(Color.white);
        g2.drawString("Selling Items : " + gp.shippingBinController.sellingItems().size() + "/" + gp.shippingBinController.sellingItemsMaxSize(), FRAME_X + 12, FRAME_Y + 22);
        String totalPriceText = "Total Price : " + gp.shippingBinController.goldEarned + "g";
        ...
        for (int i = 0; i < gp.shippingBinController.sellingItems().size(); i++) {
            ...
            if (i == gp.shippingBinController.getSelectedSlot()) {
